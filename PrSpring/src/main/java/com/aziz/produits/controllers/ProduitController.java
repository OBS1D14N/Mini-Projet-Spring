package com.aziz.produits.controllers;
...
import com.aziz.produits.service.CatService;
...
ModelMap modelMap)
{
	List<Categorie> cats = catService.findAll();
	modelMap.addAttribute("categories", cats);
List<produit> prods = produitService.findByNomProduit(nom);
modelMap.addAttribute("produits",prods);
...
cats.setIdCat(cat);
List<Categorie> cats2 = catService.findAll();
modelMap.addAttribute("categories", cats2);
List<produit> prods = produitService.findByCategorie(cats);
modelMap.addAttribute("produits",prods);
